...
class _IncomingPageState extends State<FavoritePage> {
  ...
  void initState() {
    ...
    _scopedModelFavorites.outAllFavorites.listen((onData) {
      print(
          "============Numbers Of Favorites=====${onData.data.length}=====================");
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return ScopedModel<ScopedModeFavorites>(
      ...
      child: Scaffold(
        body: Container(
          color: Colors.white,
          child: ScopedModelDescendant<ScopedModeFavorites>(builder:
              (BuildContext context, Widget child, ScopedModeFavorites model) {
                                                          ...
                                                          child: Column(
                                                            children: <Widget>[
                                                              ...
                                                              new Text(
                                                                'ريال سعودى' +
                                                                    " " +
                                                                    "${snapshot.data.data[indexList].nightNumber}",
                                                                style:
                                                                    new TextStyle(
                                                                  fontSize:
                                                                      18.0,
