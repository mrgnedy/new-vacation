...
class ReservationPaymentPageBank extends StatefulWidget {
  ...
  ReservationPaymentPageBank({this.m, this.deposit, this.coupon});

  @override
  _ReservationPaymentPageBankState createState() =>
      _ReservationPaymentPageBankState();
}

class _ReservationPaymentPageBankState extends State<ReservationPaymentPageBank>
  ...
  void validateAndSave() {
    ...
    if (form.validate()) {
      if (_image == null) {
        ...
        form.save();
        print(
            '=================== Form is valid Sucessful =====================');

        ///-------------------- send Data to Verification ---------------------//
        _scopedModelShowChalet.reservationsBill(
            context: context,
  ...
  void initState() {
    ...
    cd.stream.listen((onData) {
      ...
      setState(() {
        ...
        countSeconds = onData.inSeconds % 60;
        if (count == 1) {
          openMainPage();
        }
      });
                  ...
                  return Stack(
                    children: <Widget>[
                            ...
                            child: ListView(
                              children: <Widget>[
                                ...
                                ListTile(
                                  ...
                                  title: Text(
                                    " ${count} : ${countSeconds.toString().padLeft(1, '0')} ",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        fontFamily: 'DinNextRegular',
                                        color: Colors.red,
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      right: 5, top: 5, bottom: 15, left: 5),
                                  child: Align(
                                    alignment: Alignment.centerRight,
                                    child: Text(
                                      "حول العربون ${widget.deposit ?? 0} ريال سعودي على حساباتنا البنكيه علي نموذج التأكيد الحواله وارسل ايصال العربون ",
                                      textAlign: TextAlign.center,
                                      textDirection: TextDirection.rtl,
                                      style: TextStyle(
                                          fontFamily: 'DinNextRegular',
                                ...
                                Padding(
                                  padding:
                                      EdgeInsets.only(right: 16, bottom: 5),
                                  child: Align(
                                    alignment: Alignment.centerRight,
                                    child: Text(
                                      "الحسابات البنكيه",
                                ...
                                ListTile(
                                  trailing: FittedBox(
                                                                      child: Text(
                                      "قيمه العربون المطلوب دفعه حاليا",
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                          fontFamily: 'DinNextRegular',
                                          color: Color(0xff2E0063),
                                  ...
                                  title: FittedBox(
                                    child: Text(
                                      "${widget.deposit == null ? 0 : (num.parse(widget.deposit) * 100 / (num.parse(widget.m.data.price)) - num.parse(widget.coupon)).toStringAsFixed(3)} ريال",
                                      textAlign: TextAlign.center,
                                      textDirection: TextDirection.rtl,
                                      style: TextStyle(
                                          fontFamily: 'DinNextRegular',
                      ...
                      Align(
                        ...
                        child: InkWell(
                          onTap: () {
                            Utility.checkInternetConnection(context)
                                .then((onValue) {
                              if (onValue) {
                                print(
                                    "================UUU=====${Utility.checkInternetConnection(context) == false}======================");
                                setState(() {
                                  checkValidate = true;
                                });
                                validateAndSave();
