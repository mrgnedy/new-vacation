...
class ReservationPaymentPageBank extends StatefulWidget {
  ...
  ReservationPaymentPageBank({this.m, this.deposit});
    ...
    return ScopedModel<ScopedModelShowChalet>(
        ...
        child:  Scaffold(
                              ...
                              //---------------------------------------  Text Help   ----------------------------------//
                                ...
                                Padding(
                                  ...
                                  child: Align(
                                    alignment:Alignment.centerRight ,
                                    child: Text(
                                      "حول العربون ${widget.deposit?? 0} ريال سعودي على حساباتنا البنكيه عبي نموذج التأكيد الحواله وارسل ايصال العربون ",
                                      textAlign: TextAlign.center,
                                      textDirection: TextDirection.rtl,
                                      style: TextStyle(
                                          fontFamily: 'DinNextRegular',
            ...
            //----------------------------------
                                ...
                                ListTile(trailing:Text(
                                  "قيمه العدبون المطلوب دفعه حاليا",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      fontFamily: 'DinNextRegular',
                                      color: Color(0xff2E0063),
                                  ...
                                  title: Text(
                                    "${widget.deposit == null? 0 : widget.m.data.reservationData.price}",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        fontFamily: 'DinNextRegular',
                                        color: Colors.green,
