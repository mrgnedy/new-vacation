...
class _PageCouponState extends State<PageCoupon> {
  ...
  @override
  void initState() {
    _scopedModelShowChalet.stopLoadingPageCopun();
                          ...
                          child: InkWell(
                            onTap: () async {
                              ...
                              if (await confirmReservPolicy(
                                  'هل توافق على سياسة الحجز؟', 'تأكيد الحجز')) {
                                _scopedModelShowChalet
                                    .addReservationChalet(
                                        ...
                                        coupon: copoun ?? "")
                                    .then((s) {
                                      // print((s as SuccessReservationModel));
                                  // _scopedModelShowChalet.getPaymentInfo(
                                  //   context: context,
                                  //   id: widget.chaletId,
                                  //   reservBill: s
                                  // );
...
// inkwell color
                        ...
                        Visibility(
                          visible: ScopedModelShowChalet.loadingPageCopun,
                          child: Align(
                              alignment: Alignment.center,
                              child:
                                  SpinKitCircle(color: ColorsV.defaultColor)),
                        )
                      ],
                    );
                  }))),
