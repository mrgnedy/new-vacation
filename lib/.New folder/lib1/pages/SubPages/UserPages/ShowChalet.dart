...
class _ShowChaletUserState extends State<ShowChaletUser> {
  ...
  void initState()
  {
   ...
   // _scopedModelShowChalet.showLoadingPage();
    ...
    _scopedModelShowChalet.getDataForChalet(context: context, chaletId: widget.chaletId);
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  InkWell(
                                                   ...
                                                   getNameLocationForUser(lat1: snapshot.data.data.chalet.lat,long1: snapshot.data.data.chalet.lng);
                                ...
                                ///----------------------------------------- Btn  Done --------------------------------//
                                  InkWell(
                                    onTap: ()
                                    {
                                      ...
                                      {
                                             shawAlertDialog("ادخل بدايه الحجز ونهايه الحجز للتأكد من ان الشاليه متاح فى هذه الفتره", "فتره الحجز");
                                      }else
                                        {
                                          model.getCheckChalet(context: context,chaletId:snapshot.data.data.chalet.id.toString(),Start: StartDate,end: endDate);
                                        }
 ...
 String restTools(String idRest)
  ...
  //-----------------------Location----------------------------------//
  getNameLocationForUser({double lat1,double long1}) async {//call this async method from whereever you need
    ...
    if(isLocationEnabled)
    {
      ...
      print("=========postion=======${position.latitude} : ${position.longitude}=====================");



      if(lat1==null||long1==null)
      {
        Utility.shawAlertDialogFailedLocation(context: context,title: "خدمات مطلوبه",msg: "للحصول على الشاليهات القريبه يجب تفعيل الموقع الجغرافي");
      }else
      {
        ...
        print("-------------Lat${long1}");
        Navigator.push(context,SlideRightRoute(page: MapTypes(lat: lat1,long: long1,namelocation:locationMapName)));
