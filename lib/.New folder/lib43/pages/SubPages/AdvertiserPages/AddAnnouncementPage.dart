...
class _AddAnnouncementPageState extends State<AddAnnouncementPage> {
  ...
  TextEditingController depoCtrl = TextEditingController();
  ...
  final List<String> _itemsTypeBuildingDepartment =
      ['متاح للافراد و العائلات', "افراد", "عوائل فقط"].toList();
  ...
  void initState() {
    ...
    additions.addAll([
      {'name': 'المبيت', 'price': 0, 'add': false},
      {'name': 'تجهيز عرسان', 'price': 0, 'add': false},
      {'name': 'ملعب صابونى', 'price': 0, 'add': false}
    ]);
                  ...
                  child: ExpandablePanel(
                    ...
                    expanded: Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          // shrinkWrap: true,
                          children: List.generate(additions.length, (index) {
                            return InkWell(
                              onLongPress: () =>
                                  setState(() => additions.removeAt(index)),
                              child: Row(
                                mainAxisAlignment:
                                ...
                                children: <Widget>[
                                  Row(
                                    children: <Widget>[
                                      Checkbox(
                                        value: additions[index]['add'],
                                        onChanged: (b) {
                                          setState(() {
                                            additions[index]['add'] = b;
                                            print(additions[index]);
                                          });
                                        },
                                      ...
                                      Container(
                                          width: 100,
                                          child: Text(additions[index]['name']))
                                    ],
                                  ),
                                  Container(
                                      width: 50,
...
//                            );
                                            ...
                                            children: List.generate(
                                              ...
                                              return Container(
                                                ...
                                                child: CheckboxListTile(
                                                  ...
                                                  onChanged: (b) =>
                                                      _value1Changed(b, index),
                                                  title: Text(restStuff[index]),
                                                  controlAffinity:
                                                  ...
                                                  // secondary: new Icon(
                                                  //   Icons
                                                  //       .valu airline_seat_recline_extra,
                                                  //   color: ColorsV.defaultColor,
                                                  // ),
                                                  activeColor:
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          addDataForChalets(
                                  ...
                                  nightNUmber:
                                      _textFieldControllerPriceNight.text,
                                  NumberBathRooms:
                                      _textFieldControllerNumberRooms.text,
                                  space:
                                      __textFieldControllerAreaOfbuilding.text,
  ...
  Future addDataForChalets({
    ...
    print("================${cancelNumber}============");
    final List addedList =
        additions.where((addition) => addition['add'] == true).toList();
    ...
    if (images.length >= 6) {
      for (var s in images) {
        ...
        var gg = await MultipartFile.fromFile((pathImage));
    ...
    if (_valuec2) {
      deposit = int.parse(depoCtrl.text);
      listConditions.add("دفع عربون مقداره $deposit من قيمه الحجز");
    }
    // if (_valuec3) {
