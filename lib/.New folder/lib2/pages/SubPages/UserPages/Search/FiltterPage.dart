...
//      return null;
//    }
    if(restTools.isEmpty && (_textFieldControllerbathrooms.text.toString().isEmpty||_textFieldControllerbathrooms.text.toString()==null) && (_textFieldControllerNumberBeads.text.toString().isEmpty||_textFieldControllerNumberBeads.text.toString()==null))
    {
      Utility.shawAlertDialogFailed(
          context: context,
          title: 'بيانات غير مكتمله'
