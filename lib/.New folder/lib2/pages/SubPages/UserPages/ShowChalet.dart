...
class _ShowChaletUserState extends State<ShowChaletUser> {
                                ...
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemCount: snapshot.data.data.chalet
                                            .descriptions.length,
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        if (StartDate == null ||
                                            endDate == null) {
                                          shawAlertDialog(
                                              "ادخل بدايه الحجز ونهايه الحجز للتأكد من ان الشاليه متاح فى هذه الفتره",
                                              "فتره الحجز");
                                        } else {
  ...
  Widget buildAddition(List chaletAdd) {
    return chaletAdd.isEmpty
        ? Container(
            alignment: Alignment.center,
            child: Text('لا توجد اضافات', style: TextStyle(
              fontFamily: 'DinNextLight',
              fontWeight: FontWeight.bold,
              color: ColorsV.defaultColor,
            ),),
                ...
                children: [
                  Text(chaletAdd[index]['name'],
                      style: TextStyle(
                          color: ColorsV.defaultColor,
                          fontFamily: 'DinNextLight')),
                  Text(chaletAdd[index]['price'].toString(),
                      style: TextStyle(
                          color: ColorsV.defaultColor,
                          fontFamily: 'DinNextLight')),
                ],
